...
public class SessionizeNodeModelFactory extends AbstractDRNodeFactory<Sessionize> {

	@Override
	protected DRNodeModel<Sessionize> createDRNodeModel() {
		return new DRNodeModel<Sessionize>( new Sessionize(), new SessionizeNodeSettings());
	}

	@Override
	protected AbstractDRNodeDialogPane<Sessionize> createNodeDialogPane() {
		return new SessionizeNodeDialogPane();
	}
