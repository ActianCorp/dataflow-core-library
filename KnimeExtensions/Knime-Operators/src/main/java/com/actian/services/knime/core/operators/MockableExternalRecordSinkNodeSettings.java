...
/*package*/ final class MockableExternalRecordSinkNodeSettings extends AbstractDRSettingsModel<MockableExternalRecordSink> {
    ...
    public void configure(PortMetadata[] inputTypes,
            MockableExternalRecordSink operator) throws InvalidSettingsException {                
    }
